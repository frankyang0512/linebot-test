...
def linebot():
    try:
        ...
        line_bot_api = LineBotApi('Rk2D3AkuyqW+sn75A/yx6qwcU6BuszWH6bU1tHZKrJTWC8JLGvE1WxWBbuFIPPh0LKlcaesC5kYYeJZJfrKcrq/msCtcDmoxCcEglSUKQ6yoVxJKV16JtOlrXAk5MoxY82njPlaDHZ9MubG3qbmEhwdB04t89/1O/w1cDnyilFU=')  # 輸入 你的 Channel access token
        handler = WebhookHandler('f519fcefc7f8a4f0d31df36c302ef9ef')         # 輸入 你的 Channel secret
...
def reply_msg(text):
    ...
    # 如果出現特定圖片文字，提供圖片網址
    img_dict = {
        '機器子':'https://i.imgur.com/t9wCmdS.jpg',
